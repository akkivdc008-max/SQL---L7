...
insert into test1 values(-129); -- out o range (1 byte => 8 bit => 2**8 ( -128 to 127)
select * from test1;
...
insert into test4 values(0.7326723);-- only 2 decimal value
...
insert into test5 values('he       ');-- char length ignore spaces
